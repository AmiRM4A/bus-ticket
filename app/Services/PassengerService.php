...
{
    public static function resolvePassengersWithSeats(array $passengers_data): Collection
    {
        $nationalCodes = array_column($passengers_data, 'national_code');
        ...
        foreach ($passengers_data as $passengerData) {
